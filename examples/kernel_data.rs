use bokeh::{
    kernel_gaussian_components,
    params::{
        KERNEL1_PARAM_SET, KERNEL2_PARAM_SET, KERNEL3_PARAM_SET, KERNEL4_PARAM_SET,
        KERNEL5_PARAM_SET, KERNEL6_PARAM_SET, KERNEL7_PARAM_SET, KERNEL8_PARAM_SET,
        KERNEL9_PARAM_SET,
    },
};
use std::env;
...
fn main() -> std::io::Result<()> {
    ...
    .enumerate()
    {
        for kernel_size in [1, 5, 10, 50, 100] {
            let kernels = kernel_gaussian_components(params, f64::from(kernel_size));
